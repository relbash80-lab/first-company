...
export default function SubscriptionPage() {
  ...
  const [workspace, setWorkspace] = useState({ plans: [], subscription: null, invoices: [], memberCount: 0, activeVehicleCount: 0, storageMb: 0, entitlement: null, isPlatformAdmin: false, pendingPayments: [] });
